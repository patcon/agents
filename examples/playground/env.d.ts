/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false env.d.ts` (hash: a2edb5dff00ac9f93f1776cd971dc86d)
interface __BaseEnv_Env {
  LOADER: WorkerLoader;
  AI: Ai;
  EMAIL_SECRET: string;
  OPENROUTER_API_KEY: string;
  USE_OPENROUTER_TTS: string;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      "EMAIL_SECRET" | "OPENROUTER_API_KEY" | "USE_OPENROUTER_TTS"
    >
  > {}
}
